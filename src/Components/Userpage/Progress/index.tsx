...
const Progress = ({ goalData, done }) => {
  ...
  const result = sevenTime.filter((distance: number) => distance !== 0);
              ...
              <StyleNextProgress>
                <StyleSevenProgress>
                  ...
                  <StyleSevenDate>
                    ...
                    <div>
                      {goalData.getUserInfo.weekOfDistance.map((distance: number, idx: React.Key) => (
                    ...
                    <div>
                      {goalData.getUserInfo.weekOfTime.map((time: number, idx: React.Key) => (
